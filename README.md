...
2. Baixe o uv (pode ser instalado com `pip install uv`)
3. Com `uv sync` será baixado o python e a libs com a versão correta
4. Execute o comando `uv run src/create_measurements.py` para gerar o arquivo de teste

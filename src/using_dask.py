...
def create_dask_df():
    ...
    # O Dask não suporta a ordenação direta de DataFrames
    # Agrupados/resultantes de forma eficiente
    # Mas você pode computar o resultado e então ordená-lo
    # Se o dataset resultante não for muito grande
